    ...
    extend: {
      colors: {
        ...
        surface: {
          ...
          600: '#94a3b8',
          500: '#64748b',
          400: '#475569', /* Muted Text (Slate 600) */
          300: '#334155', /* Slate 700 */
          200: '#1e293b', /* Secondary Text (Slate 800) */
          100: '#0f172a', /* Primary Text (Slate 900) */
          50: '#020617',
        },
      },
      fontFamily: {
      ...
      animation: {
        ...
        'water-drop': 'waterDrop 3s ease-in infinite',
        'ripple-effect': 'rippleEffect 3s ease-out infinite',
      },
      keyframes: {
        fadeIn: {
          '0%': { opacity: '0' },
